    ...
    <form action="{{ route('admin.kategori.store') }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="nama_kategori" value="{{ old('nama_kategori') }}" required placeholder="Contoh: Jaringan, Mikrokontroler, Power Tools"
                class="w-full px-3 py-2 bg-slate-800 border border-slate-700 rounded-lg text-slate-100 placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-indigo-500">
