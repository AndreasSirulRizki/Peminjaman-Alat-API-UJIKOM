        ...
        <aside class="w-64 bg-slate-900 border-r border-slate-800 flex-col hidden md:flex">
            ...
            <nav class="flex-1 p-4 space-y-1">
                ...
                <a href="{{ route('petugas.pengembalian.index') }}"
                   class="flex items-center gap-3 px-4 py-2.5 rounded-lg text-sm font-medium transition
                          {{ request()->routeIs('petugas.pengembalian.*') ? 'bg-indigo-500/10 text-indigo-400 border border-indigo-500/20' : 'text-slate-400 hover:bg-slate-800 hover:text-white' }}">
                    <i class="fas fa-undo-alt w-5 text-center"></i> Pantau Pengembalian
                </a>

                <!-- Laporan -->
                <a href="{{ route('petugas.laporan') }}"
                   class="flex items-center gap-3 px-4 py-2.5 rounded-lg text-sm font-medium transition
                          {{ request()->routeIs('petugas.laporan') ? 'bg-indigo-500/10 text-indigo-400 border border-indigo-500/20' : 'text-slate-400 hover:bg-slate-800 hover:text-white' }}">
        ...
        <div class="flex-1 flex flex-col overflow-y-auto bg-slate-950">
            ...
            <header class="bg-slate-900/70 backdrop-blur border-b border-slate-800 h-16 flex items-center justify-between px-6 sticky top-0 z-10">
                <div class="text-lg font-semibold text-white">
                    @yield('header-title', 'Panel Petugas')
                </div>
